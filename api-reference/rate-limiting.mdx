---
title: "Rate Limiting"
description: "Entenda como funciona o rate limiting na API Sto Pay"
icon: "gauge"
---

## Visão Geral

A API Sto Pay implementa rate limiting para garantir estabilidade, segurança e uso justo dos recursos. Diferentes tipos de rotas têm limites diferentes baseados no método de autenticação.
...
for i in {1..25}; do
  curl -H "X-API-Key: sua_key" https://api.stopay.com.br/api/v1/user/balance
done
